...
public class AiUtils extends WebSocketListener {
    ...
    public static final String appid = "66a5c19d";
    public static final String apiSecret = "MTUzMzEyNWM1NzIxZmM2YWY5NGQ4OWRi";
    public static final String apiKey = "835dd603f5dcf5370545f6d12171f044";
    ...
    // 构造函数
    public AiUtils(String userId, Boolean wsCloseFlag) {
        this.userId = userId;
        this.wsCloseFlag = wsCloseFlag;
    }

    // 主函数
    public static String ask(String query) throws Exception {
        flag="";
        while (true) {
            ...
            if (totalFlag) {
                ...
                for (int i = 0; i < 1; i++) {
                    totalAnswer = "";
                    WebSocket webSocket = client.newWebSocket(request, new AiUtils(i + "",
                            false));
